package com.charlton.spritesheeteditor.extensions

import com.charlton.gameengine.models.ImageObject
import com.charlton.spritesheeteditor.helpers.AnimatedCellValueFactory
import com.charlton.spritesheeteditor.models.FileFormat
import com.charlton.spritesheeteditor.models.PoseFileFormat
import com.charlton.spritesheeteditor.models.ProjectileFileFormat
import com.charlton.spritesheeteditor.views.SpriteCanvasSelectionView
...
fun TableView<FileFormat.AnimationRow>.load(
    ...
    if (imageFile.exists()) {
        ...
        val defaultPoses = ImageObject.Pose.values().map { it.name }
